...
```{r, echo=FALSE, message=FALSE, warning=FALSE}	
plot_positivity <- ggplot(medford_from_state, aes(x=End_Date, y=Percent_Positivity)) + geom_line()+ theme_light() + xlab("Date") + ylab("Positivity rate of tests for the week ending this date") + ggtitle("Positivity rate in Medford")
