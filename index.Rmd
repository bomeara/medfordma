...
```{r, echo=FALSE, message=FALSE, warning=FALSE}	
plot_cases <- ggplot(medford_from_city, aes(x=DATE, y=`New Cases`)) + geom_ma(n=7)+ theme_light() + xlab("Date") + ylab("Number of new cases per day (seven day average)") + ggtitle("New covid cases in Medford per day")
print(plot_cases)
```
