...
covid_patients_vaxxed_plot <- ggplot(state_hospital_data, aes(x=Date, y=Percentage_Hospitalized_Who_Were_Vaccinated)) + geom_line() + theme_light() + ylab("Percentage of people hospitalized for covid who were fully vaccinated first") +  xlab("Date") + ggtitle("Percentage of hospitalized covid patients who were fully vaccinated in MA")
